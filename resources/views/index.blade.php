...
<body>
  <main class="container-main">
    ...
    <aside class="aside-left" id="aside-left__countries-id">
      ...
      <table class="aside-left__table">
        <thead class="aside-left__table__head">
          <tr class="aside-rigt__table__head__row">
            <td class="aside-left__table__head__row__data">
              <h2 class="aside-left__table__head__row__data__h2">
                Ligas populares
              </h2>
            </td>
          </tr>
        </thead>
        <tbody class="aside-left__table__body">
          <tr class="aside-left__table__body__league">
            <td class="aside-left__table__body__league__info">
              <div class="aside-left__table__body__league__info__logo-text">
                <img src="./images/escudos/LaLigaLogo.png" alt="logo de la liga santander" 
                  class="aside-left__table__body__league__info__logo-text__logo" width="18px">
                <div class="aside-left__table__body__league__info__logo-text__league-country">
                  <p class="aside-left__table__body__league__info__logo-text__league-country__league">
                    LaLiga Santander
                  </p>
                  <p class="aside-left__table__body__league__info__logo-text__league-country__country">
                    España
                  </p>
                </div>
            </td>
    ...
    <aside class="aside-left" id="aside-left__leagues-id">
      ...
      <div class="aside-left__league-container">
        ...
        <div class="aside-left__league-container__table-info" id="aside-left__league-container__table-info__anchor">
          ...
          <div class="aside-left__league-container__table-info__team-info">
            <div class="aside-left__league-container__table-info__team-info__image-name">
              <img class="aside-left__league-container__table-info__team-info__image-name__img" 
                src="./images/escudos/barcelona.png" alt="escudo" width="18%">
              <div class="aside-left__league-container__table-info__team-info__image-name__name">
    ...
    <div class="main-home --main">
      <h1 class="main-home__header --header">
        Eventos populares
      </h1>
      <div class="main-home__popular-events">
        <div class="main-home__popular-events__button-set">
          <button class="main-home__popular-events__button-set__button --color-purple --semibold">
            Todos
          </button>
          <button class="main-home__popular-events__button-set__button">
            En vivo
          </button>
          <button class="main-home__popular-events__button-set__button">
            Completados
        ...
        <table class="main-home__popular-events__table">
          <tr class="main-home__popular-events__table__col-name">
            <td class="main-home__popular-events__table__col-name__cell">
              <div class="main-home__popular-events__table__col-name__cell__layout">
                <p class="main-home__popular-events__table__col-name__cell__layout__name">Fecha</p>
              </div>
            </td>
            <td class="main-home__popular-events__table__col-name__cell">
              <div class="main-home__popular-events__table__col-name__cell__layout">
                <p class="main-home__popular-events__table__col-name__cell__layout__name">Partido</p>
              </div>
            </td>
            <td class="main-home__popular-events__table__col-name__cell" id="main-home__popular-events__table__col-name__cell__id-league">
              <div class="main-home__popular-events__table__col-name__cell__layout">
                <p class="main-home__popular-events__table__col-name__cell__layout__name">Liga</p>
              </div>
            </td>
          </tr>
      ...
      <div class="section-modal__main-container">
        ...
        <div class="section-modal__main-container__card-group">
          ...
          <div class="section-modal__main-container__card-group__card-container">
            ...
            <a class="section-modal__main-container__card-group__card-container__button" href="/login.html">
          ...
          <div class="section-modal__main-container__card-group__card-container">
            ...
            <a class="section-modal__main-container__card-group__card-container__button">
              <div class="section-modal__main-container__card-group__card-container__button__text">
                Suscribirse
              </div>
            </a>
