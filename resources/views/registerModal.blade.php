...
<section class="register-modal">
    ...
    <form action="#" class="register-modal__register-form">
      <input type="text" name="name" id="nameInput" class="register-modal__register-form__user-input --input" placeholder="Nombre">
      <input type="text" name="surname" id="surnameInput" class="register-modal__register-form__user-input --input" placeholder="Apellido">
      ...
      <input type="date" name="birthDate" id="birthDate" class="register-modal__register-form__passwdRepeat-input --input">
